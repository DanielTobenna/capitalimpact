...
def home(request):
	return render(request, 'nomura_corporation_app/home.html')

def about(request):
	return render(request, 'nomura_corporation_app/about.html')

def blockchainfund(request):
	return render(request, 'nomura_corporation_app/blockchainfund.html')

def liquidtoken(request):
	return HttpResponse('Liquid Token will be launched soon')

def bitcointradingfund(request):
	return render(request, 'nomura_corporation_app/bitcointradingfund.html')

def earlystagetoken(request):
	return HttpResponse('Early Stage Token will be launched soon')

def stakingfund(request):
	return render(request, 'nomura_corporation_app/stakingfund.html')

def energies(request):
	return render(request, 'nomura_corporation_app/energies.html')

def sharestrading(request):
	return render(request, 'nomura_corporation_app/sharestrading.html')

def agriculturalfund(request):
	return render(request, 'nomura_corporation_app/agriculturalfund.html')

def nonfarmpayroll(request):
	return render(request, 'nomura_corporation_app/nonfarmpayroll.html')

def renewableenergy(request):
	return render(request, 'nomura_corporation_app/renewableenergy.html')

def investmentmanagement(request):
	return render(request, 'nomura_corporation_app/investmentmanagement.html')

def financialservice(request):
	return render(request, 'nomura_corporation_app/financialservice.html')

def portfoliomanagementservice(request):
	return render(request, 'nomura_corporation_app/portfoliomanagementservice.html')

def financialadvising(request):
	return render(request, 'nomura_corporation_app/financialadvising.html')

def pressrelease(request):
	return render(request, 'nomura_corporation_app/about.html')

def faqs(request):
	return render(request, 'nomura_corporation_app/faqs.html')

def terms(request):
	return render(request, 'nomura_corporation_app/terms.html')

def privacy(request):
	return render(request, 'nomura_corporation_app/privacy.html')

def otherpayment(request):
	return HttpResponse('Sorry but this method of payment is not available to you at the moment. Please, try using any available cryptocurrency of your choice, or contact support@capitalimpactinvest.com for help')

def contact(request):
	return render(request, 'nomura_corporation_app/contact.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'nomura_corporation_app/main.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('nomura_corporation_app/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'nomura_corporation_app/signin.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('nomura_corporation_app/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('nomura_corporation_app/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('nomura_corporation_app/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@capitalimpactinvest.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'nomura_corporation_app/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'nomura_corporation_app/dashboard.html', context)

@login_required(login_url='signin')
def plans(request):
	plans= Plan.objects.all()
	context= {'plans':plans}
	return render(request, 'nomura_corporation_app/plans.html', context)
...
def notifications(request):
	...
	return render(request, 'nomura_corporation_app/notifications.html', context)
...
def admindashboard(request):
	...
	return render(request, 'nomura_corporation_app/adminpage.html', context)
...
def deposit(request):
	...
	if request.method=='POST':
		...
		order_id= 'Capital Impact Invest'
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.capitalimpactinvest.com/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.capitalimpactinvest.com/dashboard"
			})
			...
			template= render_to_string('nomura_corporation_app/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@capitalimpactinvest.com'])
			except BadHeaderError:
				pass
			return redirect(generated_link)
	context={'packages':packages}
	return render(request, 'nomura_corporation_app/deposit.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@capitalimpactinvest.com'])
	...
	context={}
	return render(request, 'nomura_corporation_app/withdrawal.html', context)
...
def history(request):
	...
	return render(request, 'nomura_corporation_app/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'nomura_corporation_app/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'nomura_corporation_app/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'nomura_corporation_app/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'nomura_corporation_app/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'nomura_corporation_app/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'nomura_corporation_app/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('nomura_corporation_app/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('nomura_corporation_app/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'nomura_corporation_app/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	if float(payment_info_investment_plan) == float(0.012):
		packageName= 'Prime Package'
	if float(payment_info_investment_plan) == float(0.0154):
		packageName= 'Executive Package'
	if float(payment_info_investment_plan) == float(0.0187):
		packageName= 'Premium Package'
	if float(payment_info_investment_plan) == float(0.02):
		packageName= 'Master Package'
	if float(payment_info_investment_plan) == float(0.026):
		packageName= 'Master PRO Package'
	template= render_to_string('nomura_corporation_app/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'nomura_corporation_app/account_settings.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('nomura_corporation_app/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('nomura_corporation_app/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@capitalimpactinvest.com'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'nomura_corporation_app/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'nomura_corporation_app/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('nomura_corporation_app/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('nomura_corporation_app/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@capitalimpactinvest.com'])
			except BadHeaderError:
				pass
	...
	context= {'packages': packages}
	return render(request, 'nomura_corporation_app/reinvest.html', context)